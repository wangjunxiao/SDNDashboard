...
/**
 * This interface is implemented by factory components which provide instances to the flex messaging framework. To configure flex data services to use
 * this factory, add the following lines to your services-config.xml file (located in the WEB-INF/flex directory of your web application).
 * 
 * &lt;factories&gt; &lt;factory id="spring" class="flex.samples.factories.SpringFactory" /&gt; &lt;/factories&gt;
 * 
 * You also must configure the web application to use spring and must copy the spring.jar file into your WEB-INF/lib directory. To configure your app
 * server to use spring, you add the following lines to your WEB-INF/web.xml file:
 * 
 * &lt;context-param&gt; &lt;param-name&gt;contextConfigLocation&lt;/param-name&gt;
 * &lt;param-value&gt;/WEB-INF/applicationContext.xml&lt;/param-value&gt; &lt;/context-param&gt;
 * 
 * &lt;listener&gt; &lt;listener-class&gt;org.springframework.web.context.ContextLoaderListener&lt;/listenerclass& gt; &lt;/listener&gt;
 * 
 * Then you put your spring bean configuration in WEB-INF/applicationContext.xml (as per the line above). For example:
 * 
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt; &lt;!DOCTYPE beans PUBLIC "-//SPRING//DTD BEAN//EN" "http://www.springframework.org/dtd/
 * spring-beans.dtd"&gt;
 * 
 * &lt;beans&gt; &lt;bean name="weatherBean" class="dev.weather.WeatherService" singleton="true"/&gt; &lt;/beans&gt;
 * 
 * Now you are ready to define a destination in flex that maps to this existing service. To do this you'd add this to your
 * WEB-INF/flex/remoting-config.xml:
 * 
 * &lt;destination id="WeatherService"&gt; &lt;properties&gt; &lt;factory&gt;spring&lt;/factory&gt; &lt;source&gt;weatherBean&lt;/source&gt;
